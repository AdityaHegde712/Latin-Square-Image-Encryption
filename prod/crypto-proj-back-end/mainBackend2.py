<<<<<<< HEAD:prod/crypto-proj-back-end/mainBackend.py
import os
...
def encryptTotal(gray):
    ...
    # Decryption
    img2 = cv2.imread('buffer/aa_LogisticDec.png')
    gray = cv2.cvtColor(img2, cv2.COLOR_BGR2GRAY)
    LD = LatinSqDec2(gray,LE[1])
    cv2.imwrite('buffer/latinDec.png',LD)
    img3 = cv2.imread('buffer/latinDec.png')
    return img, img3
...
if __name__ == "__main__":
    ...
    img, img3 = encryptTotal(gray)
    cv2.imshow('img', img)
    cv2.imshow('img3', img3)
    cv2.waitKey(0)

>>>>>>> ccc1bbc5d4ea9470f614fecf5a21ddde5cc4bf44:prod/crypto-proj-back-end/mainBackend2.py
